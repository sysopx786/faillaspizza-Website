...
export function GoogleListingCard({ className }: { className?: string }) {
  return (
    <div className={cn("rounded-xl bg-cream p-6 ring-1 ring-line", className)}>
      <p className="text-xs font-semibold uppercase tracking-[0.16em] text-tomato">
        Google
      </p>
      ...
      <p className="mt-2 text-sm leading-relaxed text-muted">
        Live hours, popular times, and reviews — the same listing that shows
        up in Google Search.
      </p>
      <a
      ...
      >
        <Button>Open Google listing</Button>
      </a>
      <a
